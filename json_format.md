...
{
  "source": "topcv",
  "source_url": "[https://www.topcv.vn/viec-lam/abc](https://www.topcv.vn/viec-lam/abc)",
  "normalized_source_url": "[https://www.topcv.vn/viec-lam/abc](https://www.topcv.vn/viec-lam/abc)",
  "crawl_version": 1,
  "ingest_ts": 1714492800000,
  "event_ts": 1714406400000,
  "job_id": "e3b0c44298...",
  "hash_content": "8b1a9953c...",
  "payload": {
    "title": "Data Engineer (Spark/Hadoop)",
    "company_name": "Công ty Cổ phần ABC",
    "company_scale": "100-499 nhân viên",
    "company_field": "IT - Phần mềm",
    "company_address": "Tầng 3, Tòa nhà XYZ, Hà Nội",
    "salary": "20 - 30 Triệu",
    "location": ["Hà Nội", "Hồ Chí Minh"],
    "monthOfExperience": "2 năm",
    "deadline": 1717174799000,
    "occupationalCategory": "Nhân viên",
    "education": "Đại Học trở lên",
    "employmentType": "Toàn thời gian",
    "openings": 2,
    "description": [
      "Xây dựng và tối ưu hóa hệ thống Data Warehouse.",
      "Phát triển các pipeline ETL bằng PySpark."
    ],
    "requirements": [
      "Có ít nhất 2 năm kinh nghiệm với Big Data.",
      "Thành thạo Python, SQL và Apache Spark."
    ],
    "benefits": [
      "Thưởng tháng 13, BHXH đầy đủ.",
      "Môi trường làm việc trẻ trung."
    ],
    "income": [],
    "schedule": "Thứ 2 - Thứ 6 (08:30 - 18:00)",
    "skillsNeeded": ["Python", "Apache Spark", "SQL"],
    "skillsShouldHave": ["Kafka", "Hadoop"],
    "specialty": ["Software Engineer", "Data Engineer"],
    "extra_inf": {},
    "meta_tags": {"viewport": "width=device-width"},
    "json_ld": {"@type": "JobPosting"},
    "pageText": "Tuyển Data Engineer làm việc tại..."
  },
  "quality_flags": {
    "has_json_ld": true,
    "has_page_text": true,
    "has_structured_company_name_conflict": false,
    "has_valid_posting_date": true,
